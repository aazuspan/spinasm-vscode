...
from spinasm_lsp.server import server as LSP_SERVER
...
TOOL_MODULE = "spinasm-vscode"

TOOL_DISPLAY = "SPINAsm"
...
def _run_tool_on_document(
    ...
    if use_path:
        ...
        with utils.substitute_attr(sys, "path", sys.path[:]):
            try:
                # TODO: `utils.run_module` is equivalent to running `python -m spinasm-vscode`.
